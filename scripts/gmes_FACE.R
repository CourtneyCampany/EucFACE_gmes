...
plot(LMA~leafw, data=growCO2, col=co2grow, pch=pchs[canopy], ylab="LMA",
...
plot(gmes~leafw, data=growCO2, col=co2grow, pch=pchs[canopy], ylab=gmlab, xlab = "cell wall thickness" ,ylim=c(0,0.5)) 
