...
### Analysis of anatomical measurements _ EucFACE_gmes leaves 
# Clean up workspace
rm(list = ls())
library(doBy)
library(lattice)
...
setwd("//ad.uws.edu.au/dfshare/HomesHWK$/30021697/My Documents/Documents_Crous/EucFACE/Kristine-TDL/TDL_Oct2014")
#read in datafile
across <-read.csv("Tree_aver_age_position_EucFACE030517.csv") #data for four campaigns where we have upper and lower canopy results
